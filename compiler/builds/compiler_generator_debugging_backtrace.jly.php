            ...
            <?php foreach ($backtrace as $trace) {
                    ...
                    if (!empty($cause)) {
                        $error_message = $cause->message; ?>
                            <p class="exception-message"><?php echo $error_message; ?></p>
                        <?php $error_file_contents = highlight_file($cause->file, true);
                        ...
                        <p class="error-file-name">in <?php echo $cause->file . ' on line ' . $cause->line; ?></p>
                        <p class="error-block-container"><?php echo $error_block; ?></p>
                ...
                <?php foreach ($backtrace as $frame) : ?>
                    <div class="stack-frame">
                        ...
                        <?php if(isset($frame->file)) { ?>
                            <div class="stack-file"><?php echo $frame->file; ?></div>
                        <?php } else if(isset($frame->class)) { ?>
                            <div class="stack-file"><?php echo $frame->class; ?></div>
                        <?php } ?>

                        <?php if(isset($frame->line)) { ?>
                            <div class="stack-line">Line <?php echo $frame->line; ?></div>
                        <?php } ?>
                        ...
                        <?php if(isset($frame->function)) { ?>
                            <div class="stack-function">
                                ...
                                <?php if(isset($frame->class)) { ?>
                                    | Class: <?php echo $frame->class; ?>
                                <?php } ?>
                            </div>
                        <?php } ?>

                        <?php if(!isset($frame->function) && isset($frame->class)) { ?>
                            <div class="stack-class">Class: <?php echo $frame->class; ?></div>
                        <?php } ?>

                        <?php if(isset($frame->type)) { ?>
                            <!-- <div class="stack-type"><?php echo $frame->type; ?></div> -->
                        <?php } ?>
